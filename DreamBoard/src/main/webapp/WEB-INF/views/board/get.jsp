				...
				<div class="col-lg-7">
					<table class="table table-bordered">
						<tr>
							<td>번호</td>
							<td>
								<input type="text" class="form-control" name="boardIdx" readonly="readonly" value="${vo.boardIdx}" />
							</td>
						...
						<tr>
							<td>제목</td>
							<td>
								<input type="text" class="form-control" name="title" readonly="readonly" value="<c:out value='${vo.title}'/>" />
							</td>
						...
						<tr>
							<td>내용</td>
							<td>
								<textarea rows="10" class="form-control" name="content" readonly="readonly"><c:out value='${vo.content}' /></textarea>
							</td>
						</tr>
						<tr>
							<td>작성자</td>
						...
						<tr>
							...
							<c:if test="${empty mvo}">
								...
								<button disabled="disabled" class="btn btn-sm btn-success" onclick="location.href='${contextPath}/board/modify?boardIdx=${vo.boardIdx}'">수정</button>
							</c:if>
